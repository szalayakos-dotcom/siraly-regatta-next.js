...
export default function EntryPage() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      const creditsAfter = credits - totalCost
      ...
      // player_races létrehozása a levonás utáni kredittel
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--background)' }}>
      ...
      <div style={{ borderBottom: '1px solid var(--border)', background: 'var(--card)', padding: '12px 24px', display: 'flex', alignItems: 'center', gap: '12px' }}>
        <button onClick={() => router.push('/')} style={{ display: 'flex', alignItems: 'center', gap: '6px', color: 'var(--muted-foreground)', background: 'none', border: 'none', cursor: 'pointer', fontSize: '12px', fontFamily: 'var(--font-heading)', letterSpacing: '1px' }}>
